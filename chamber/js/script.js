...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 1. Preenche o campo hidden "timestamp" se estiver na página join.html
  const timestampField = document.getElementById("timestamp");
  if (timestampField) {
    // Define o valor como a data/hora atual (formato local ou ISO)
    timestampField.value = new Date().toLocaleString();
  }

  // 2. Controle de modais (botões de abrir e spans de fechar)
